...
main(int, char**)
  {
    ...
    assert(strcmp(hfst_utf8toupper(one), one) == 0);
    assert(strcmp(hfst_utf8toupper(A), A) == 0);
    assert(strcmp(hfst_utf8toupper(a), A) == 0);
    assert(strcmp(hfst_utf8toupper(Auml), Auml) == 0);
    assert(strcmp(hfst_utf8toupper(auml), Auml) == 0);
    assert(strcmp(hfst_utf8toupper(ndash), ndash) == 0);
    assert(strcmp(hfst_utf8toupper(cjk281ab), cjk281ab) == 0);
    fprintf(stdout, "ok.\n");
    fprintf(stdout, "hfst_utf8tolower...");
    assert(strcmp(hfst_utf8tolower(one), one) == 0);
    assert(strcmp(hfst_utf8tolower(A), a) == 0);
    assert(strcmp(hfst_utf8tolower(a), a) == 0);
    assert(strcmp(hfst_utf8tolower(Auml), auml) == 0);
    assert(strcmp(hfst_utf8tolower(auml), auml) == 0);
    assert(strcmp(hfst_utf8tolower(ndash), ndash) == 0);
    assert(strcmp(hfst_utf8tolower(cjk281ab), cjk281ab) == 0);
    fprintf(stdout, "ok.\n");
    fprintf(stdout, "hfst_utf8totitle...");
    assert(strcmp(hfst_utf8totitle(one), one) == 0);
    assert(strcmp(hfst_utf8totitle(A), A) == 0);
    assert(strcmp(hfst_utf8totitle(a), A) == 0);
    assert(strcmp(hfst_utf8totitle(Auml), Auml) == 0);
    assert(strcmp(hfst_utf8totitle(auml), Auml) == 0);
    assert(strcmp(hfst_utf8totitle(ndash), ndash) == 0);
    assert(strcmp(hfst_utf8totitle(cjk281ab), cjk281ab) == 0);
    fprintf(stdout, "ok.\n");

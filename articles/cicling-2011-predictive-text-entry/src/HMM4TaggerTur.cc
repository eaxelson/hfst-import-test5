...
ConfigStringPair config_string_pairs[4] =
  {hmm_config_string_pair0, hmm_config_string_pair1, hmm_config_string_pair2, hmm_config_string_pair3};

ConfigStringPairVector hmm_config_string_pair_vector(config_string_pairs,
						     config_string_pairs + 4);

float f = 0.60;
float k = 1.4;
//float coeffs[3] = {k*0.28,k*0.34,k*0.38};
//float coeffs[4] = {k*0.4,f*k*0.48,f*k*0.24,f*k*0.28};
float coeffs[4] = {0.272271,0.165448,0.56228,0};

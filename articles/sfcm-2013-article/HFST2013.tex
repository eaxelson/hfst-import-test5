...
Saura    9 Saura : Sauraa : Saurat : Saurain, Saurojen : Sauroja :
           Sauroihin
Peura    9 Peura : Peuraa :  Peurat : Peurain, Peurojen : Peuroja :
           Peuroihin
...
\ex
% When using XeLaTeX, without [everygla=], each word in \gla seems to
% be displayed as "it" in italics. With PDFLaTeX, it would seem to
% work correctly.
\begingl %[everygla=]

...
environment, the resulting alphabet would be differen't from XFST's, it
would in both cases be \verb+a+, \verb+b+.

We haven't managed to find an example in which this difference might influence
the correctnes of the result, but pruning alphabet does result with

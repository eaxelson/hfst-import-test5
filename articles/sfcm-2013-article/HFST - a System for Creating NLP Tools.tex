...
OMorFii~\footnote{http://code.google.com/p/omorfi/} The open-source
Finnish morphology, the three top guesses for ``twiitin'' are (the
markup is slightly simplified): \small
\begin{verbatim}

...
// Compare class for comparing input and output labels of arcs.
// (First input and then output labels.)  -- by Erik Axelson
template<class A> class IOLabelCompare {
 public:
  bool operator() (const A &arc1, const A &arc2) const {
...
// -- by Erik Axelson 
typedef IOLabelCompare<StdArc> StdIOLabelCompare;

...
{ 
  if (T) {
    ...
    /*    Alphabet alpha;
    fprintf(stderr, "..TheAlphabet:\n");
    TheAlphabet.print();
    alpha.copy(TheAlphabet);
    fprintf(stderr, "..alpha:\n");
    alpha.print();   // OK this far
    KeyTable *alpha_t = alpha.to_key_table(TheAlphabet);
    if (binary) {
      fprintf(stderr, "Writing alpha_t in binary format:\n");
      alpha_t->write(os, TheAlphabet);
    }
    else {
      fprintf(stderr, "Writing alpha_t in text format:\n");
      alpha_t->print(TheAlphabet);
      alpha_t->write_in_text_format(os, TheAlphabet);
    }
    }*/

//! @file hfst-unweighted2weighted.cc
//!
//! @brief Weighting transducer command line tool
//!
//! @author HFST Team
...
print_usage(const char *program_name)
{
	...
	fprintf(message_out, "Usage: %s [OPTIONS...] [INFILE]\n"
		"Convert an unweighted transducer to a weighted one\n"		  
		"\n", program_name);
...
#               endif
	...
	fprintf(stderr, "\n");
	print_more_info(message_out, "Unweighted2Weighted");
	fprintf(stderr, "\n");
		...
		try {
		  ...
		  bool transducer_has_symbol_table=false;
			...
			while (true) {
				...
				VERBOSE_PRINT("Converting to weighted transducer...\n");

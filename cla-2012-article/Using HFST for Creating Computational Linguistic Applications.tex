...
We use the newest version of HFST, 3.3.4, with SFST, OpenFst and foma as
...
This improvement comes from SFST's new efficient minimization and composition functions
that were developed jointly with the HFST team based on our previous benchmarking.

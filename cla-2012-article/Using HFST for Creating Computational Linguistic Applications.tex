...
morphologies using different HFST back-ends. The morphologies are OMorFi for Finnish,
Morphisto for German, Morph-it for Italian, Swelex for Swedish and TrMorph for Turkish 
(todo: add footnotes). OMorFi, Morphisto and Morph-it have several rules for
inflection and compounding, Morph-it and Swelex are basically word-lists.
The HFST back-ends are SFST, OpenFst and foma.
...
earlier benchmarking (footnote). The back-end versions are also shown.

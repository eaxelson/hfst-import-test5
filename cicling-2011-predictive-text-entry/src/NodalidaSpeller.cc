#include "NodalidaSpeller.h"

using hfst::TROPICAL_OPENFST_TYPE;

NodalidaSpeller::NodalidaSpeller(const std::string &lexical_model_file_name,
				 const std::string &sequence_model_file_name,
				 float scaling_coefficient):
  NodalidaTagger(lexical_model_file_name,sequence_model_file_name),
  scaling_coefficient(scaling_coefficient)
{}

std::string NodalidaSpeller::get_correct_spelling

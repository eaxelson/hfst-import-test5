...
%
% Note to Krister: consider a table in Introduction or Discussion with available
% functional morphologies, keeping in mind
% eg. trmorph and http://dev.sslmit.unibo.it/linguistics/morph-it.php
%
% For some additional comments search for 'FMT:'
%
...
%- uudet kirjastot helppo liittää
%- rajapinta ja rakenne selkeämpi
%- operaatioiden yhteiskäyttö
%- varauduttu laajennuksiin, esim. painot 
...
{\verb hfst-calculate} that processes the SFST formalism which does not
...
phonological rules to a two-level lexicon. The result of the operation
...
\hline
North S\'{a}mi  & 364s & 63s \\
\hline
Finnish   &       &
\end{tabular}
\vskip.2cm
\caption{Runtimes for intersecting composition of the Finnish and North S\'{a}mi morphological analyzers in HFST2 and HFST3.}
\end{center}
\end{table}
...
\end{table}
%% FMT:  Perhaps mention how the numbers were calculated, are they averages ?
%%       is the 5 second difference significant ?
...
%% FMT: Intead of 'language model' perhaps "perform morphological analysis and generation" ?
...
released on HFST's site on 2010-04-14.}
\end{center}
\end{table}

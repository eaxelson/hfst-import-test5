...
static unsigned int current_fsm_linecount, current_state_no, current_final, current_start, current_trans, num_finals, arity, statecount;
...
void fsm_construct_add_arc_ints(struct fsm_construct_handle *handle, int source, int target, int in, int out) {

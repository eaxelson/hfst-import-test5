...
Xerox tool twolc, but it augments twolc functionality by providing a new type of rules. In \textbf{hfst-twolc}, rules can have can have negative contexts.
\begin{figure}
{\footnotesize
\begin{verbatim}
...
remove rule conflicts.~\footnote{Not that, if prohibition rules would

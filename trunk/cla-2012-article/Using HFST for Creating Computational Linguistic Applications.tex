...
We present a general account of using replace rules with the \verb!hfst-regexp2fst! command-line tool.
...
disjunction of morphs to create the final lexicon. In effect, we create a filter
...
\begin{verbatim}
  ...
  $ hfst-disjunct cont0 cont1 cont2  |  hfst-repeat -f 1 > conts
  $ hfst-concatenate start conts end > morphotactics
...
\cite{conf/fsmnlp/2009} by Silfverberg and Lind\'{e}n), obviating the

...
We took a sample X of sentences and developed our set of rules for tagging all the \verb+Size+ frame examples 
to determine how laborious the task would be and what coverage could be expected with our current set of tools.

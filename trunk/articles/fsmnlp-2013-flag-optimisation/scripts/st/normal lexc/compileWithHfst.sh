...
hfst-compose-intersect ../bin/deu-lex.hfst ../bin/twol.hfst | hfst-minimize > ../bin/deu.hfst 
...
hfst-lexc -f foma -o ../bin/grn-lex.hfst ../tmp/grn-lex.all
...
hfst-compose -F -1 ../bin/grn-lex.hfst -2 ../bin/grn-bin.hfst | hfst-minimize > ../bin/grn.hfst 
...
hfst-compose-intersect ../bin/kmr-lex.hfst ../bin/twol.hfst | hfst-minimize > ../bin/kmr.hfst 

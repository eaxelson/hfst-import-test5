...
\begin{tabularx}{0.6\textwidth}{lCCCCCC}
\hline
...
\hline
Class & \multicolumn{1}{c}{Sg Nom} & \multicolumn{1}{c}{Sg Gen} & \multicolumn{1}{c}{Sg Part} & \multicolumn{1}{c}{Sg Ill}  & \multicolumn{1}{c}{Pl Nom} & \multicolumn{1}{c}{Pl Gen}      & \multicolumn{1}{c}{Pl Part} & \multicolumn{1}{c}{Pl Ill}\\
\hline
...
\begin{verbatim}
transducer = libhfst.HfstTransducer(
    libhfst.HfstInputStream("transducer.hfst"))
...
use HFST command line tools (other than \verb+hfst-xfst+).

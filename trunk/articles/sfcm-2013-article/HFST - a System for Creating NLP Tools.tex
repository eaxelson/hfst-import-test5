...
language bindings via SWIG. It is possible to use the full HFST library
through its SWIG interfaces in all supported systems with Python
versions 2 and 3.
...
command line tools: hfst-shuffle and hfst-prune-alphabet. Some existing

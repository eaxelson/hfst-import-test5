...
less isolating languages. Overviewing previous
...
spell-checking applications: English as a sample of a morphologically more
isolating language with a basically word-list approach to spell-checking; as a
...
For agglutinative languages like Finnish, for which the

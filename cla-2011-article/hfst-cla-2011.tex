...
layout. In this paper, we investigate the role the training data,
...
system gives suggestions in order of weight.
...
The authors would like to thank Sam Hardwick for supplying us with IRC logs as well as the 12 people who volunteered their text messages to be used as test data. We would also like to express our gratitude towards the reviewers whose comments we found enlightening and useful. [TODO: lisaa rahoittajat]

//! @file hfst-weighted2unweighted.cc
//!
//! @brief Transducer unweighting command line tool
//!
//! @author HFST Team
...
print_usage(const char *program_name)
{
	...
	fprintf(message_out, "Usage: %s [OPTIONS...] [INFILE]\n"
		"Convert a weighted transducer to an unweighted one\n"
		"\n", program_name);
...
#               endif
	...
	fprintf(stderr, "\n");
	print_more_info(message_out, "Weighted2Unweighted");
	fprintf(stderr, "\n");
		...
		try {
		  ...
		  bool transducer_has_symbol_table=false;
			...
			while (true) 
			{
				...
				VERBOSE_PRINT("Converting to unweighted transducer...\n");
